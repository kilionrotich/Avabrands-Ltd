function News({ posts, bgImages }) {
  return (
    <section id="news" className="border-t border-teal-primary/10 bg-[#f0e9dc] py-20 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between bg-[#f8f4ed]/70 backdrop-blur-sm rounded-2xl p-6 -mx-6">
          <div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {posts.map((post) => (
            <article key={post.id} className="rounded-2xl border border-teal-secondary/20 bg-[#f8f4ed]/95 backdrop-blur-sm p-6 hover:border-teal-secondary/40 transition shadow-md">
